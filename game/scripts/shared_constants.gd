...
const BOT_TARGET_CORNER_WEIGHT := 4.0
const BOT_TARGET_ISOLATION_WEIGHT := 6.0
const BOT_TARGET_CORNER_SAMPLE_DIST := 5.0
const BOT_SHOOT_RANGE := 18.0
const BOT_SHOOT_AIM_JITTER := 0.09
const RETARGET_HYSTERESIS := 0.75
const BOT_INVESTIGATE_MS := 3000.0
const BOT_FIRE_THREAT_LOOKBACK := 12.0
const BOT_DODGE_RADIUS := 1.0
const BOT_DODGE_LEAD_S := 0.35
const BOT_CHASE_FLANK_RADIUS := 4.0
const BOT_CHASE_FLANK_RELEASE_DIST := 6.0
const BOT_SPRINT_TRIGGER_RADIUS := 10.0
const BOT_FLEE_PROJECTION := 12.0
const BOT_FLEE_CANDIDATES := 12.0
const BOT_FLEE_WALL_PENALTY := 12.0
...
const BOT_ITEM_CONTEST_RADIUS := 12.0
const BOT_ITEM_DENY_WEIGHT := 8.0
const BOT_LEAP_REACH := 3.0
const BOT_TURN_ANTICIPATE_MS := 800.0
const BOT_TURN_STANDOFF_BUFFER := 1.0
